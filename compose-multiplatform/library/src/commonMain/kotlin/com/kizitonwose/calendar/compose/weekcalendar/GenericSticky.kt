...
@Composable
public inline fun StickyHeaderList(
    state: LazyListState,
    modifier: Modifier,
...
@Composable
public inline fun StickyHeaderGrid(
    state: LazyGridState,
    modifier: Modifier,
...
@Composable
public inline fun StickyHeaderStaggeredGrid(
...
@Composable
public inline fun <LazyState : ScrollableState, LazyItem> StickyHeaderLayout(
    lazyState: LazyState,
